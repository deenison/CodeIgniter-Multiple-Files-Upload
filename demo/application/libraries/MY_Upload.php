...
class MY_Upload extends CI_Upload
{
    ...
    public function do_upload($field = 'userfile')
    {
        ...
        if (is_string($_file['name'])) {
            return $this->uploadFileObject($_file);
        } else {
            $this->set_error('upload_no_file_selected', 'debug');
    ...
    /**
     * Perform a file upload based on its $_FILES data.
     *
     * @param   array  $_file
     * @return  bool
     */
    public function uploadFileObject($_file)
    {
        $_file = json_decode(json_encode($_file), TRUE);
